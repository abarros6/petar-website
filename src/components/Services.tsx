      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-10 lg:mb-16 gap-4 lg:gap-6">
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#153243] leading-tight">
              Our Services
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200">
          {services.map((service) => (
            <div
              key={service.number}
              className="group bg-white p-6 lg:p-8 hover:bg-[#1a6c7a] transition-colors duration-300 cursor-pointer"
            >
              ...
              <span className="inline-flex items-center gap-2 text-xs font-semibold tracking-widest uppercase text-[#b39f79]">
                Explore
                <svg
